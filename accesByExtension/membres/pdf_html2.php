...
.tdSerie   { padding:3px 0 3px 10px;  background-color:#660000; color:#FFCC00; font-size:14px; font-weight:bold; width:100%;}
.tdSubSerie   {color:#660000; font-size:10px;}
...
while ($DB->next_record() and ($num<300))
{
	...
	if ($DB->f("id_serie") !== $current_id_serie)
	{
		...
		echo '
		<div class="expTitle" style="width : 100%">
	...
	$info = traiteChaine($info);
	echo '<div class="expFieldBlock" style="min-width:45%;">';
	echo '<div class="expFieldBlock" align="center">'
	.$info["NUM_TOME"].'<br />
	<img src="'.BDO_URL_COUV.$info["IMG_COUV"].'" border="0" width="90">
	</div>
	';
	echo '<div class="expFieldBlock">';
