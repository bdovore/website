        ...
        if (User::minAccesslevel(1)) {
            ...
            if ($act == "update") {
                ...
                $this->Auteur->set_dataPaste(array(
                    ...
                    "FLG_SCULPT" => postVal('chkSculpt') == 'checked' ? 1 : 0,
                    "FLG_DESIGN" => postVal('chkDesign') == 'checked' ? 1 : 0,
                    "FLG_PEINT" => postVal('chkPeint') == 'checked' ? 1 : 0,
...
// AFFICHER UN AUTEUR
            elseif ($act == "") {
                ...
                $this->view->set_var(array
                    ...
                    "ISSCULPT" => $this->Auteur->FLG_SCULPT == 1 ? "checked" : '',
                    "ISDESIGN" => $this->Auteur->FLG_DESIGN == 1 ? "checked" : '',
                    "ISPEINT" => $this->Auteur->FLG_PEINT == 1 ? "checked" : '',
