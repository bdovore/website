    ...
    public function editPropositionAjout() {
        ...
        if (User::minAccesslevel(1)) {
            ...
            $this->view->set_var(array(
                ...
                "DESCRIB_EDITION" => !is_null($this->User_album_prop->DESCRIB_EDITION) ? stripslashes($this->User_album_prop->DESCRIB_EDITION) : "",
                "USERCOMMENT" => !is_null($this->User_album_prop->COMMENTAIRE) ? stripslashes($this->User_album_prop->COMMENTAIRE) : "",
