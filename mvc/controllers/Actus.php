...

{
...

    {
        ...
        $requete = "SELECT * FROM news WHERE news_level>=5  ORDER BY News_id DESC LIMIT 0, ".$limit;
    ...
    public function lastCommentaires ()
