	...
	WHERE 
        ...
        elseif ($mode == 2) {
                    ...
                    FROM 
                            ...
                            INNER JOIN bd_tome  ON list.id_serie=bd_tome.id_serie
                            
                    WHERE 
                            (t.id_scenar IN (SELECT id_auteur FROM users_list_aut WHERE user_id = ". $_SESSION['userConnect']->user_id.") OR 
                                t.id_dessin IN (SELECT id_auteur FROM users_list_aut WHERE user_id = ". $_SESSION['userConnect']->user_id."))
