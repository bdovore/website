...
<table width="100%" border="1">
  ...
  <tr bgcolor="#FFFFCC">
    <td width="50%" bordercolor="#CCCCCC" bgcolor="#CCCCCC"> <p><strong>EDITEUR
        A SUPPRIMER</strong></p>
      <form name="form1" method="post" action="" onSubmit="return urlsource()">
        <input name="txtField1Id" type="text" id="txtField1Id" value="{EDITEURID1}" size="5">
        <input name="txtField1" type="text" id="txtField1" value="{EDITEUR1}" size="40">
        <a href="{URLEDITEDIT1}"><img src="{URLSITEIMAGE}edit.gif" width="18" height="13" border="0"></a>
        <img src="{URLSITEIMAGE}site/loupe.gif" width="24" height="14" onClick="newWindow('editeur',document.form1.txtField1.value,'form1','txtField1',true)"><br>
        <input name="Submit1" type="submit" id="Submit1" value="Rafraichir">
      </form></td>
    <td width="50%"> <p><strong>EDITEUR A GARDER</strong></p>
      <form name="form2" method="post" action="" onSubmit="return urldest()">
        <input name="txtField2Id" type="text" id="txtField2Id" value="{EDITEURID2}" size="5">
        <input name="txtField2" type="text" id="txtField2" value="{EDITEUR2}" size="40">
        <a href="{URLEDITEDIT2}"><img src="{URLSITEIMAGE}edit.gif" width="18" height="13" border="0"></a>
        <img src="{URLSITEIMAGE}site/loupe.gif" width="24" height="14" onClick="newWindow('editeur',document.form2.txtField2.value,'form2','txtField2',true)"><br>
        <input name="Submit1" type="submit" id="Submit1" value="Rafraichir">
      </form></td>
  </tr>
  <tr>
    <td><table width="100%" border="1" cellspacing="0">
        <tr bordercolor="#CCCCCC" bgcolor="#CCCCCC">
          <td width="22%">Site WEB</td>
          <td width="78%">{URLSITE1}</td>
        </tr>
      </table></td>
    <td><table width="100%" border="1" cellspacing="0">
        <tr bordercolor="#FFFFCC" bgcolor="#FFFFCC">
          <td width="22%">Site WEB</td>
          <td width="78%">{URLSITE2}</td>
        </tr>
      </table></td>
  </tr>
  <tr>
    <td bgcolor="#CCCCCC"> <p><strong>Statistiques</strong></p>
      <p>{NBUSERS1} utilisateur(s) ont cet editeur dans leur collection.</p></td>
    <td bordercolor="#FFFFCC" bgcolor="#FFFFCC"> <p><strong>Statistiques</strong></p>
      <p>{NBUSERS2} utilisateur(s) ont cet editeur dans leur collection.</p></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><p><a href="{URLECHANGE}">Inverser la séléction</a><br>
        <a href="{URLFUSION}" onClick="return valider()">Fusionner les deux &eacute;diteurs</a></p></td>
  </tr>
</table>
