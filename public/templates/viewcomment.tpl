  <!-- BEGIN CmtBlock -->
<table id="{DTEPOST}" width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#B64444"> 
    <tr bordercolor="#FFFFFF"> 
        ...
        <td bordercolor="#B64444" bgcolor="#C8857C"> 
            <div align="right"><font face="Arial, Helvetica, sans-serif" size="1">
                <font color="#0000ff" face="Arial, Helvetica, sans-serif" size="2"><font color="#333333">
                    Postée par <b>{USERNAME}</b>
                </font></font> 
                le {CMTDATE}
            </font>{URLDELETE}</div>
        </td> 
